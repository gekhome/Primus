...
namespace Primus.DAL
{
    ...
    public partial class ΑΠΟΦΑΣΗ_ΣΤΕΓΑΣΗ
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public ΑΠΟΦΑΣΗ_ΣΤΕΓΑΣΗ()
        {
            this.ΕΠΙΔΟΜΑ_ΣΤΕΓΑΣΗ = new HashSet<ΕΠΙΔΟΜΑ_ΣΤΕΓΑΣΗ>();
        }
        ...
        public virtual ICollection<ΕΠΙΔΟΜΑ_ΣΤΕΓΑΣΗ> ΕΠΙΔΟΜΑ_ΣΤΕΓΑΣΗ { get; set; }
    }
}
