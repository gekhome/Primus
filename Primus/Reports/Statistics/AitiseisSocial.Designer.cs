namespace Primus.Reports.Statistics
{
    ...
    "ull";
            ...
            // graph1
            // 
            graphGroup1.Label = "йоимымийг олада";
            ...
            graphGroup4.Groupings.Add(new Telerik.Reporting.Grouping("=Fields.йоимымийг_олада"));
            ...
            this.sqlDataSource1.SelectCommand = "SELECT        пкгхос, пососто, сумоко, SCHOOLYEAR_TEXT, свокийо_етос, йоимымийг_о" +
    "лада\r\nFROM            statаитгсеис_етос_олада\r\nORDER BY йоимымийг_олада";
            // 
            // barSeries1
            // 
            this.barSeries1.ArrangeMode = Telerik.Reporting.GraphSeriesArrangeMode.Stacked100;
            graphGroup2.Label = "йоимымийг олада";
            ...
            this.barSeries1.LegendItem.Value = "= Fields.йоимымийг_олада";
            graphGroup3.Groupings.Add(new Telerik.Reporting.Grouping("=Fields.йоимымийг_олада"));
    ...
    "DER BY SCHOOLYEAR_TEXT";
            ...
            this.textBox3.Value = "= Fields.йоимымийг_олада";
            // 
            // textBox5
            // 
            ...
            this.textBox4.Value = "йоимымийг олада:";
            // 
            // textBox1
            // 
            ...
            this.textBox1.Value = "йатамолг аитгсеым ле ч выяис йоимымийа йяитгяиа";
            // 
            // AitiseisSocial
            // 
